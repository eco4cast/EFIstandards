...
#forecast_project_id <- uuid::UUIDgenerate() # generate a new ID
forecast_project_id <- 30405043              # Reuse an ID that applies to a specific workflow and model version
...
data_assimilation <- rep(1, n_time)  ## this code indicates a 'free-run hindcast'
